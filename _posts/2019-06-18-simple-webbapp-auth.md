...
current: post
cover:  image_0.png
title: Using WoTT credentials to manage HTTP Basic Authentication for a Python 3 WebApp
...
{% asset tutorials/simple-webapp-auth/wott-login.png srcset:width="1300 2x" srcset:width="650 1x" alt="WoTT Login" class="img-fluid" %}
...
{% asset tutorials/simple-webapp-auth/wott-dash.png srcset:width="1300 2x" srcset:width="650 1x" alt="WoTT Credentials" class="img-fluid" %}
...
{% asset tutorials/simple-webapp-auth/device-list.png srcset:width="1300 2x" srcset:width="650 1x" alt="device list" class="img-fluid" %}
...
{% asset tutorials/simple-webapp-auth/hello.png srcset:width="1300 2x" srcset:width="650 1x" alt="login successful" class="img-fluid" %}
